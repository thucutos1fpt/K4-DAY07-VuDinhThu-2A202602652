...
class SentenceChunker:
    ...
    def chunk(self, text: str) -> list[str]:
        ...
        # Keep the punctuation with the sentence.  This is deliberately a
        # lightweight sentence splitter: the lab only requires the common
        # English punctuation boundaries documented above.
        sentences = [
            sentence.strip()
...
class RecursiveChunker:
    ...
    def _split(self, current_text: str, remaining_separators: list[str]) -> list[str]:
        ...
        # No useful separator remains: character splitting is the final
        # fallback, so this method always terminates for very long words too.
